#!/bin/bash
# Build Driver Consistency Analyzer Windows exe using Wine
...
echo "========================================="
echo " Driver Consistency Analyzer Build (Wine)"
echo "========================================="
...
cp -r "$SCRIPT_DIR/src/driver_consistency_analyzer" "$BUILD_DIR/src/"
...
a = Analysis(
    ['src/driver_consistency_analyzer/main.py'],
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['IPython', 'jupyter', 'notebook', 'qtpy', 'PyQt5', 'PyQt6', 'plotly'],
    noarchive=False,
)
...
if [ -f "$BUILD_DIR/dist/DriverConsistencyAnalyzer.exe" ]; then
    ...
    cp "$BUILD_DIR/dist/DriverConsistencyAnalyzer.exe" "$SCRIPT_DIR/dist/"

    EXE_SIZE=$(du -h "$SCRIPT_DIR/dist/DriverConsistencyAnalyzer.exe" | cut -f1)

    echo ""
    echo "========================================="
    echo " BUILD SUCCESSFUL!"
    echo " Output: desktop_app_driver/dist/DriverConsistencyAnalyzer.exe"
    echo " Size: $EXE_SIZE"
    echo "========================================="
    echo ""
