    ...
    ts = pa.table(
        {
            ...
            "tpms_press_fl_bar": pa.array(
                [2.40, 2.40, 2.40, 2.45, 2.50], type=pa.float32()
            ),
            "tpms_press_fr_bar": pa.array(
                [2.30, 2.31, 2.32, 2.33, 2.34], type=pa.float32()
            ),
            "tpms_temp_fl_c": pa.array(
                [30.0, 30.0, 30.0, 32.0, 34.0], type=pa.float32()
            ),
        }
    )
