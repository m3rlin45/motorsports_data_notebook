...
class TestPrepareThrottleAcceptance:
    ...
    def test_adapts_threshold_for_capped_sensor(self):
        ...
        _, eff_thresh = prepare_throttle_acceptance(
            throttle, lateral_g, throttle_threshold=98.0
        )
    ...
    def test_smoothing_window_affects_output(self):
        ...
        smoothed_small, _ = prepare_throttle_acceptance(
            throttle, lateral_g, smoothing_window=3
        )
        smoothed_large, _ = prepare_throttle_acceptance(
            throttle, lateral_g, smoothing_window=25
        )
...
class TestFindThrottleAcceptanceFromArrays:
    ...
    def test_basic_detection(self):
        ...
        result = find_throttle_acceptance_from_arrays(
            distance, timecodes, throttle, lateral_g, corner,
            throttle_threshold=98.0, sustain_time_ms=500, smoothing_window=5,
        )
    ...
    def test_matches_dataframe_version(self):
        ...
        result_df = find_throttle_acceptance(
            lap_data, corner, TEST_CHANNEL_NAMES,
            throttle_threshold=98.0, sustain_time_ms=500, smoothing_window=5,
        )
