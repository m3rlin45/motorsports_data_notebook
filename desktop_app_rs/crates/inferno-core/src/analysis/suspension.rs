...
mod tests {
    ...
    fn test_velocity_range_pcts() {
        ...
        let mut vel = vec![];
        vel.extend(std::iter::repeat(2.0).take(20)); // friction
        vel.extend(std::iter::repeat(15.0).take(20)); // slow bump
        vel.extend(std::iter::repeat(-15.0).take(20)); // slow rebound
        vel.extend(std::iter::repeat(100.0).take(20)); // fast bump
        vel.extend(std::iter::repeat(-100.0).take(10)); // fast rebound
        vel.extend(std::iter::repeat(250.0).take(10)); // curb
