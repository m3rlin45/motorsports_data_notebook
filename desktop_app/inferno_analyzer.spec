...
"""PyInstaller spec file for Inferno Analyzer."""
...
a = Analysis(
    [str(src_dir / "inferno_analyzer" / "main.py")],
    ...
    datas=[
        ...
        # Include builtin profiles data directory
        (
            str(repo_root / "src" / "motorsports_data_notebook" / "data"),
            "motorsports_data_notebook/data",
        ),
    ],
    hiddenimports=[
        # Matplotlib backend
